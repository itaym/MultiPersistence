...
/**
 * Base-16 accommodate rules on the first-cell digit (even digits 2, 4, 6, 8, A, C, E; odd
 * digits have no rule). A matching rule bumps the digit or splits the cell via `splitAfterCell`
 * and returns the permutations skipped. The per-digit conditions on `cTCNFC()`, the presence
 * and counts of digits 6 / 10 / 12, and the split sizes live in the `fnN` bodies below.
 *
 * @function base00016
